...
When contributing to this repository, please first discuss the change you wish to make via an [issue](https://github.com/benmaier/fincoretails/issues/new).

Please note we have a [code of conduct](https://github.com/benmaier/fincoretails/blob/master/CODE_OF_CONDUCT.md), please follow it in all your interactions with the project.
...
3. Increase the version number in [fincoretails/metadata.py](https://github.com/benmaier/fincoretails/blob/master/fincoretails/metadata.py) and the README.md to the new version that this
